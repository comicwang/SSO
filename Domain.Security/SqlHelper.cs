...
{ 
        ...
        {
            return ExecuteNonQuery(GetConnection(), CommandType.Text, commandText, (MySqlParameter[])null);
        }
        ...
        {
            // 执行参数为空的方法   
            return ExecuteScalar(GetConnection(), CommandType.Text, commandText, (MySqlParameter[])null);
        }
